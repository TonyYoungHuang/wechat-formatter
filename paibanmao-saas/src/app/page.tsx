...
const pricingCards = [
  {
    ...
    features: ["Claude Sonnet 文字生成", "每天 1 次五入口内容生成", "1 个账号档案", "图片提示词", "Gemini 图片模型生图：0 张"],
  },
  {
    name: "入门版",
    price: "¥19.90",
    ...
    features: ["Claude Sonnet 文字生成", "每月 150 次五入口内容生成", "3 个账号档案", "Gemini 图片模型生图：3 张/天，60 张/月", "每天最多做 1 组小绿书图文"],
  },
  {
    name: "专业版",
    price: "¥69.00",
    ...
    features: ["Claude Sonnet 文字生成", "每月 500 次五入口内容生成", "10 个账号档案", "Gemini 图片模型生图：10 张/天，300 张/月", "每天最多做 3 组左右小绿书图文", "高级发布前检查"],
  },
];
      ...
      <section className="border-b border-emerald-100/80 bg-white py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 flex flex-col gap-3">
            ...
            <h2 className="text-2xl font-semibold text-slate-950">Claude Sonnet 文字生成 + Gemini 图片模型生图</h2>
            <p className="max-w-3xl text-base leading-7 text-slate-600">
              新网站上线促销中，文字内容统一使用 Claude Sonnet 生成，套餐内同时包含微信五入口内容生成和小绿书 Gemini 生图额度。免费版只提供图片提示词，不包含真生图。
            </p>
          </div>
